...
### Initial Infection
- The initial exploit was traced to **AcroRd32.exe (PID 1752)** following execution of a malicious PDF file.
- The PDF was likely downloaded and opened via **firefox.exe (PID 888)**.
- **MITRE ATT&CK:** [T1566.001 – Spearphishing Attachment](https://attack.mitre.org/techniques/T1566/001/) | [T1204.002 – Malicious File](https://attack.mitre.org/techniques/T1204/002/)
...
- **MITRE ATT&CK:** [T1005 – Data from Local System](https://attack.mitre.org/techniques/T1005/) *(inferred from Zbot family characteristics, not directly observed)* | [T1071.001 – Application Layer Protocol: Web Protocols](https://attack.mitre.org/techniques/T1071/001/) *(C2 URLs identified in memory strings of PID 880)
